        ...
        $servicesData = [
            'services' => [
                [
                    ...
                    'icon' => 'mdi-home-city',
                    'action' => 'print',
                    'route' => '/print/surat-keterangan-domisili',
                    'color' => '#c2282a',
                ...
                [
                    ...
                    'icon' => 'mdi-briefcase',
                    'action' => 'print',
                    'route' => '/print/surat-keterangan-usaha',
                    'color' => '#c2282a',
                    'category' => 'administrasi',
                    'active' => true,
                    'order' => 2,
                ...
                [
                    ...
                    'icon' => 'mdi-hand-heart',
                    'action' => 'print',
                    'route' => '/print/surat-keterangan-tidak-mampu',
                    'color' => '#c2282a',
                    'category' => 'administrasi',
                    'active' => true,
                    'order' => 3,
                ...
                [
                    ...
                    'icon' => 'mdi-ring',
                    'action' => 'print',
                    'route' => '/print/surat-pengantar-nikah',
                    'color' => '#c2282a',
                    'category' => 'administrasi',
                    'active' => true,
                    'order' => 4,
                ...
                [
                    ...
                    'action' => 'print',
                    'route' => '/print/surat-pengantar-skck',
                    'color' => '#c2282a',
                    'category' => 'administrasi',
                    'active' => true,
                    'order' => 5,
                ...
                [
                    ...
                    'icon' => 'mdi-handshake',
                    'action' => 'print',
                    'route' => '/print/permohonan-bantuan-sosial',
                    'color' => '#c2282a',
                    'category' => 'bantuan',
                    'active' => true,
                    'order' => 6,
                ...
                [
                    ...
                    'icon' => 'mdi-tree',
                    'action' => 'print',
                    'route' => '/print/izin-penebangan-kayu',
                    'color' => '#c2282a',
                    'category' => 'perizinan',
                    'active' => true,
                    'order' => 7,
